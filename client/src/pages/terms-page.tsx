        ...
        <div className="space-y-6">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Welcome to vApps. These Terms of Service govern your use of our website located at 
              vApps.com (together or individually "Service") operated by Vheüel.
            </p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3">2. Communications</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              When you submit projects or other content on vApps, you retain all rights to your content. 
              However, by submitting content to vApps, you grant us a worldwide, non-exclusive, royalty-free 
              license to use, reproduce, adapt, publish, translate and distribute your content in any existing 
              or future media. You also grant us the right to sub-license these rights, and the right to bring 
            ...
            <p className="text-muted-foreground leading-relaxed mt-2">
              ...
              and must not be capable of giving rise to legal action against any person. You must not 
              submit content that is or has ever been the subject of any threatened or actual legal proceedings 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              are and will remain the exclusive property of Vheüel and its licensors. The Service is protected by 
              copyright, trademark, and other laws of both the country and foreign countries. Our trademarks and 
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3">6. Links To Other Web Sites</h2>
            <p className="text-muted-foreground leading-relaxed">
              Our Service may contain links to third party web sites or services that are not owned or controlled by Vheüel.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-2">
              Vheüel has no control over, and assumes no responsibility for the content, privacy policies, 
              or practices of any third party web sites or services. We do not warrant the offerings of any 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              In no event shall Vheüel, nor its directors, employees, partners, agents, suppliers, or 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              you should review these pages periodically. When we change the Terms in a material manner, we will 
